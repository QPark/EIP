...
public class EipPersistenceConfig {
	...
	public static final String PERSISTENCE_UNIT_NAME = "com.qpark.eip.core.persistence";
	/** The name of the entity manager factory. */
	public static final String ENTITY_MANAGER_FACTORY_NAME = "ComQparkEipCoreEntityManagerFactory";
	/** The name of the transaction manager. */
	public static final String TRANSACTION_MANAGER_NAME = "ComQparkEipCoreTransactionManager";
	/** The name of the {@link EipJpaVendorAdapterConfiguration} bean name. */
	public static final String JPA_VENDOR_ADAPTER_CONFIGURATION_BEAN_NAME = "ComQparkEipCoreEipPersistenceJpaVendorAdapterConfiguration";
