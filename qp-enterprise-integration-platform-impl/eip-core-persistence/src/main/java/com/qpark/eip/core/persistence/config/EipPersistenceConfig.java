...
/**
 * Provides the spring config of the eip persistence authority. The
 * {@link DataSource} to use has the name {@value #DATASOURCE_BEAN_NAME}.
 *
 * @author bhausen
 */
@Configuration
...
public class EipPersistenceConfig {
	...
	if (jpaVendorAdapter == null) {
	    throw new RuntimeException("ComQparkEipCoreEntityManagerFactory jpaVendorAdpater not set properly "
	...
	if (this.jpaVendorAdpaterDatabasePlatform == null
	    ...
	    throw new RuntimeException(
		    "ComQparkEipCoreEntityManagerFactory jpaVendorAdpaterDatabasePlatform not set properly "
			    + String.valueOf(this.jpaVendorAdpaterDatabasePlatform) + ".");
	}

	LocalContainerEntityManagerFactoryBean bean = new LocalContainerEntityManagerFactoryBean();
	bean.setPersistenceXmlLocation("classpath:/META-INF/com.qpark.eip.core.persistence/persistence.xml");
	...
	jpaVendorAdapter.setDatabasePlatform(this.jpaVendorAdpaterDatabasePlatform);
	...
	if (this.jpaVendorAdapterClassName == null
		|| this.jpaVendorAdapterClassName.equals("org.springframework.orm.jpa.vendor.HibernateJpaVendorAdapter")
		|| this.jpaVendorAdapterClassName.equalsIgnoreCase("Hibernate")) {
	    jpaVendorAdapter = new HibernateJpaVendorAdapter();
	} else if (this.jpaVendorAdapterClassName
		.equals("org.springframework.orm.jpa.vendor.EclipseLinkJpaVendorAdapter")
		|| this.jpaVendorAdapterClassName.equalsIgnoreCase("EclipseLink")) {
	    jpaVendorAdapter = new EclipseLinkJpaVendorAdapter();
	} else if (this.jpaVendorAdapterClassName.equals("org.springframework.orm.jpa.vendor.OpenJpaVendorAdapter")
	...
	if (this.jpaVendorAdapterGenerateDdl != null) {
	    ...
	    if (this.jpaVendorAdpaterDatabasePlatform.equals("org.hibernate.dialect.HSQLDialect")
		    || this.jpaVendorAdpaterDatabasePlatform.equals(Database.HSQL.name())) {
		value = true;
	    }
	}
	return value;
     ...
     *            {@link AbstractJpaVendorAdapter}.
     */
    public void setJpaVendorAdapterGenerateDdl(final boolean jpaVendorAdapterGenerateDdl) {
