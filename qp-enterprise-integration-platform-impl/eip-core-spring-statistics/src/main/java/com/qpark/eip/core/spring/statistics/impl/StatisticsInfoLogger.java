...
public class StatisticsInfoLogger implements StatisticsListener {
  ...
  /**
   *
   * @see com.qpark.eip.core.spring.statistics.StatisticsListener#addChannelInvocation(com.qpark.eip.core.domain.persistencedefinition.ApplicationUserLogType)
   */
  @Override
  public void addChannelInvocation(final ApplicationUserLogType log) {
    this.logger.info("{}, {}, {}, {}, {}, {}, {}, {}", log.getContext(), log.getVersion(),
        log.getUserName(), log.getServiceName(), log.getOperationName(), log.getDurationString(),
        log.getReturnedEntities(), log.getReturnedFailures());
  }

  /**
   *
   * @see com.qpark.eip.core.spring.statistics.StatisticsListener#addChannelInvocation(com.qpark.eip.core.domain.persistencedefinition.SystemUserLogType)
   */
  @Override
  public void addChannelInvocation(final SystemUserLogType log) {
    this.logger.info("{}, {}, {}, {}, {}, {}", log.getContext(), log.getVersion(),
        log.getUserName(), log.getServiceName(), log.getOperationName());
  }
