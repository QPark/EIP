...
ALTER TABLE OPERATIONTYPE DROP CONSTRAINT PRTONTYPERQSTOPERATIONTYPEHJID;
ALTER TABLE OPERATIONTYPE DROP CONSTRAINT PRTNTYPERSPNSOPERATIONTYPEHJID;
...
DROP INDEX PRTNTYPPRTNTYPRQSTPRTNTYPEHJID;
DROP INDEX PRTNTYPPRTNTYPRSPNSPRTNTYPHJID;
