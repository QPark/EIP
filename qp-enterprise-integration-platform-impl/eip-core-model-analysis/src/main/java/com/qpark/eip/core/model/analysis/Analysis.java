...
public class Analysis {
	private final Map<String, Object> identifiables = new HashMap<String, Object>();
	...
	private Map<String, DomainType> domainMap = new TreeMap<String, DomainType>();
	/** The {@link Map} of names with their {@link ClusterType}. */
	private Map<String, ClusterType> clusterMap = new TreeMap<String, ClusterType>();
	/** The {@link Map} of names with their {@link ServiceType}. */
	private Map<String, ServiceType> serviceMap = new TreeMap<String, ServiceType>();
	/** The {@link Map} of names with their {@link ElementType}. */
	private Map<String, ElementType> elementMap = new TreeMap<String, ElementType>();
	...
	Analysis(final EnterpriseType enterprise) {
