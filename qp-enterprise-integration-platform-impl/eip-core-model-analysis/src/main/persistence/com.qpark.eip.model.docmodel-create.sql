...
CREATE TABLE DIRECTMAPPINGTYPE (HJID NUMBER(19) NOT NULL, ACCESSOR VARCHAR2(511) NULL, DIRECTMAPPINGTYPE_CLUSTERTYP_0 NUMBER(19) NULL, PRIMARY KEY (HJID));
...
CREATE TABLE ELEMENTTYPE (HJID NUMBER(19) NOT NULL, DTYPE VARCHAR2(31) NULL, COMPLEXTYPEID VARCHAR2(36) NULL, DESCRIPTION VARCHAR2(2047) NULL, ID VARCHAR2(36) NULL, MODELVERSION VARCHAR2(127) NULL, NAME_ VARCHAR2(511) NULL, NAMESPACE VARCHAR2(511) NULL, PARENTID VARCHAR2(36) NULL, ELEMENTTYPE_CLUSTERTYPE_HJID NUMBER(19) NULL, PRIMARY KEY (HJID));
...
CREATE TABLE FLOWFILTERTYPE (HJID NUMBER(19) NOT NULL, DTYPE VARCHAR2(31) NULL, ID VARCHAR2(36) NULL, MODELVERSION VARCHAR2(127) NULL, NAME_ VARCHAR2(511) NULL, NAMESPACE VARCHAR2(511) NULL, PARENTID VARCHAR2(36) NULL, FILTERINOUT_FLOWFILTERTYPE_H_0 NUMBER(19) NULL, FILTER_FLOWPROCESSTYPE_HJID NUMBER(19) NULL, PRIMARY KEY (HJID));
...
CREATE TABLE FLOWMAPINOUTTYPE (HJID NUMBER(19) NOT NULL, DTYPE VARCHAR2(31) NULL, ID VARCHAR2(36) NULL, MODELVERSION VARCHAR2(127) NULL, NAME_ VARCHAR2(511) NULL, NAMESPACE VARCHAR2(511) NULL, PARENTID VARCHAR2(36) NULL, MAPINOUT_FLOWMAPINOUTTYPE_HJ_0 NUMBER(19) NULL, MAPINOUT_FLOWPROCESSTYPE_HJID NUMBER(19) NULL, PRIMARY KEY (HJID));
...
CREATE TABLE FLOWPROCESSTYPE (HJID NUMBER(19) NOT NULL, DTYPE VARCHAR2(31) NULL, ID VARCHAR2(36) NULL, MODELVERSION VARCHAR2(127) NULL, NAME_ VARCHAR2(511) NULL, NAMESPACE VARCHAR2(511) NULL, PARENTID VARCHAR2(36) NULL, REQUESTRESPONSE_FLOWPROCESST_0 NUMBER(19) NULL, PRIMARY KEY (HJID));
CREATE INDEX FLWPRCSSTYPRQSTRSPNSFLWPRCSST0 ON FLOWPROCESSTYPE (REQUESTRESPONSE_FLOWPROCESST_0);
CREATE TABLE FLOWSUBREQUESTTYPE (HJID NUMBER(19) NOT NULL, DTYPE VARCHAR2(31) NULL, ID VARCHAR2(36) NULL, MODELVERSION VARCHAR2(127) NULL, NAME_ VARCHAR2(511) NULL, NAMESPACE VARCHAR2(511) NULL, PARENTID VARCHAR2(36) NULL, SUBREQUESTINOUT_FLOWSUBREQUE_0 NUMBER(19) NULL, SUBREQUEST_FLOWPROCESSTYPE_H_0 NUMBER(19) NULL, PRIMARY KEY (HJID));
...
CREATE TABLE OPERATIONTYPE (HJID NUMBER(19) NOT NULL, DTYPE VARCHAR2(31) NULL, DESCRIPTION VARCHAR2(2047) NULL, ID VARCHAR2(36) NULL, MODELVERSION VARCHAR2(127) NULL, NAME_ VARCHAR2(511) NULL, NAMESPACE VARCHAR2(511) NULL, PARENTID VARCHAR2(36) NULL, SECURITYROLENAME VARCHAR2(511) NULL, SHORTNAME VARCHAR2(511) NULL, REQUEST_OPERATIONTYPE_HJID NUMBER(19) NULL, RESPONSE_OPERATIONTYPE_HJID NUMBER(19) NULL, OPERATION__SERVICETYPE_HJID NUMBER(19) NULL, PRIMARY KEY (HJID));
...
CREATE TABLE REQUESTRESPONSEDATATYPE (HJID NUMBER(19) NOT NULL, DTYPE VARCHAR2(31) NULL, ID VARCHAR2(36) NULL, MODELVERSION VARCHAR2(127) NULL, NAME_ VARCHAR2(511) NULL, NAMESPACE VARCHAR2(511) NULL, PARENTID VARCHAR2(36) NULL, REQUESTID VARCHAR2(36) NULL, RESPONSEID VARCHAR2(36) NULL, PRIMARY KEY (HJID));
