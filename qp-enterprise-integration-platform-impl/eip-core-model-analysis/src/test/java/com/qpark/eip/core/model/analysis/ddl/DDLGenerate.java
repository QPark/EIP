...
public class DDLGenerate {
	public static void main(final String[] args) {
		...
		String createFileName = new StringBuffer(64).append(persistenceUnitName)
				.append("-create.sql").toString();
		String dropFileName = new StringBuffer(64).append(persistenceUnitName)
		...
		fixGeneratedScriptProblems(createFileName, persistenceUnitName,
				"Create", generateDate);
		fixGeneratedScriptProblems(dropFileName, persistenceUnitName, "Drop",
				generateDate);
	}
