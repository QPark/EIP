...
-- Generated at 20160103-080032.867.
-----------------------------------------------------------------------------
-- Verify sequence handling at the end of the script

CREATE TABLE CLUSTERTYPE (HJID NUMBER(19) NOT NULL, DTYPE VARCHAR2(31) NULL, DESCRIPTION VARCHAR2(255) NULL, FILENAME VARCHAR2(255) NULL, ID VARCHAR2(255) NULL, NAME_ VARCHAR2(255) NULL, PACKAGENAME VARCHAR2(255) NULL, PARENTID VARCHAR2(255) NULL, VERSION_ VARCHAR2(255) NULL, CLUSTER__DOMAINTYPE_HJID NUMBER(19) NULL, PRIMARY KEY (HJID));
CREATE INDEX CLSTRTYPCLSTRTYPCLSTRDMNTYPHJD ON CLUSTERTYPE (CLUSTER__DOMAINTYPE_HJID);
CREATE TABLE DATATYPE (HJID NUMBER(19) NOT NULL, DTYPE VARCHAR2(31) NULL, DESCRIPTION VARCHAR2(255) NULL, ID VARCHAR2(255) NULL, JAVACLASSNAME VARCHAR2(255) NULL, JAVAPACKAGENAME VARCHAR2(255) NULL, NAME_ VARCHAR2(255) NULL, NAMESPACE VARCHAR2(255) NULL, PARENTID VARCHAR2(255) NULL, BASICDATATYPES_ENTERPRISETYP_0 NUMBER(19) NULL, PRIMARY KEY (HJID));
...
CREATE TABLE DOMAINTYPE (HJID NUMBER(19) NOT NULL, DTYPE VARCHAR2(31) NULL, DESCRIPTION VARCHAR2(255) NULL, ID VARCHAR2(255) NULL, NAME_ VARCHAR2(255) NULL, PARENTID VARCHAR2(255) NULL, SUBNAME VARCHAR2(255) NULL, SUBSUBNAME VARCHAR2(255) NULL, SUBSUBSUBNAME VARCHAR2(255) NULL, DOMAINS_ENTERPRISETYPE_HJID NUMBER(19) NULL, PRIMARY KEY (HJID));
CREATE INDEX DMNTYPDMNTYPDMNSNTRPRSTYPEHJID ON DOMAINTYPE (DOMAINS_ENTERPRISETYPE_HJID);
CREATE TABLE ELEMENTTYPE (HJID NUMBER(19) NOT NULL, DTYPE VARCHAR2(31) NULL, COMPLEXTYPEID VARCHAR2(255) NULL, DESCRIPTION VARCHAR2(255) NULL, ID VARCHAR2(255) NULL, NAME_ VARCHAR2(255) NULL, NAMESPACE VARCHAR2(255) NULL, PARENTID VARCHAR2(255) NULL, ELEMENTTYPE_CLUSTERTYPE_HJID NUMBER(19) NULL, PRIMARY KEY (HJID));
...
CREATE TABLE FLOWFILTERTYPE (HJID NUMBER(19) NOT NULL, DTYPE VARCHAR2(31) NULL, ID VARCHAR2(255) NULL, NAME_ VARCHAR2(255) NULL, NAMESPACE VARCHAR2(255) NULL, PARENTID VARCHAR2(255) NULL, FILTERINOUT_FLOWFILTERTYPE_H_0 NUMBER(19) NULL, FILTER_FLOWPROCESSTYPE_HJID NUMBER(19) NULL, PRIMARY KEY (HJID));
...
CREATE TABLE FLOWMAPINOUTTYPE (HJID NUMBER(19) NOT NULL, DTYPE VARCHAR2(31) NULL, ID VARCHAR2(255) NULL, NAME_ VARCHAR2(255) NULL, NAMESPACE VARCHAR2(255) NULL, PARENTID VARCHAR2(255) NULL, MAPINOUT_FLOWMAPINOUTTYPE_HJ_0 NUMBER(19) NULL, MAPINOUT_FLOWPROCESSTYPE_HJID NUMBER(19) NULL, PRIMARY KEY (HJID));
...
CREATE TABLE FLOWPROCESSTYPE (HJID NUMBER(19) NOT NULL, DTYPE VARCHAR2(31) NULL, ID VARCHAR2(255) NULL, NAME_ VARCHAR2(255) NULL, NAMESPACE VARCHAR2(255) NULL, PARENTID VARCHAR2(255) NULL, REQUESTRESPONSE_FLOWPROCESST_0 NUMBER(19) NULL, PRIMARY KEY (HJID));
CREATE INDEX FLWPRCSSTYPRQSTRSPNSFLWPRCSST0 ON FLOWPROCESSTYPE (REQUESTRESPONSE_FLOWPROCESST_0);
CREATE TABLE FLOWSUBREQUESTTYPE (HJID NUMBER(19) NOT NULL, DTYPE VARCHAR2(31) NULL, ID VARCHAR2(255) NULL, NAME_ VARCHAR2(255) NULL, NAMESPACE VARCHAR2(255) NULL, PARENTID VARCHAR2(255) NULL, SUBREQUESTINOUT_FLOWSUBREQUE_0 NUMBER(19) NULL, SUBREQUEST_FLOWPROCESSTYPE_H_0 NUMBER(19) NULL, PRIMARY KEY (HJID));
...
CREATE TABLE OPERATIONTYPE (HJID NUMBER(19) NOT NULL, DTYPE VARCHAR2(31) NULL, DESCRIPTION VARCHAR2(255) NULL, ID VARCHAR2(255) NULL, NAME_ VARCHAR2(255) NULL, NAMESPACE VARCHAR2(255) NULL, PARENTID VARCHAR2(255) NULL, REQUEST_OPERATIONTYPE_HJID NUMBER(19) NULL, RESPONSE_OPERATIONTYPE_HJID NUMBER(19) NULL, OPERATION__SERVICETYPE_HJID NUMBER(19) NULL, PRIMARY KEY (HJID));
...
CREATE TABLE REQUESTRESPONSEDATATYPE (HJID NUMBER(19) NOT NULL, DTYPE VARCHAR2(31) NULL, ID VARCHAR2(255) NULL, NAME_ VARCHAR2(255) NULL, NAMESPACE VARCHAR2(255) NULL, PARENTID VARCHAR2(255) NULL, REQUESTID VARCHAR2(255) NULL, RESPONSEID VARCHAR2(255) NULL, PRIMARY KEY (HJID));
CREATE TABLE SERVICETYPE (HJID NUMBER(19) NOT NULL, DTYPE VARCHAR2(31) NULL, CLUSTERID VARCHAR2(255) NULL, DESCRIPTION VARCHAR2(255) NULL, ID VARCHAR2(255) NULL, NAME_ VARCHAR2(255) NULL, NAMESPACE VARCHAR2(255) NULL, PACKAGENAME VARCHAR2(255) NULL, PARENTID VARCHAR2(255) NULL, SERVICEID VARCHAR2(255) NULL, SERVICE_DOMAINTYPE_HJID NUMBER(19) NULL, PRIMARY KEY (HJID));
