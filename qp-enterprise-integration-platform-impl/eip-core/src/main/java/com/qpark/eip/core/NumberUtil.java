...
public abstract class NumberUtil {
	 ...
	 * @param delta
	 *            the accepted variance to be interpreted as equal.
	 * @return equal or not.
	 */
	...
	/**
	 * @param pattern
	 *            the {@link DecimalFormat} pattern.
	 * @return The default {@link DecimalFormat} of the pattern with
	 *         {@link Locale#ENGLISH}.
	 */
	 ...
	 *
	 * @param b
	 *            the {@link BigDecimal} to compare.
