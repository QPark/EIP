...
public abstract class GetClosest {
	...
	public static void main(final String[] args) {
		System.out.println(getClosestIndex(BigDecimal.ONE, BigDecimal.TEN,
	...
	/**
	 * @param ref The reference value to check against.
	 * @param bigDecimals The list of {@link BigDecimal}s to check.
	...
	/**
	 * @param ref The reference value to check against.
	 * @param bigDecimals The {@link Collection} of {@link BigDecimal}s to
	 *            check.
	 * @return the closest {@link BigDecimal} to the reference value out of the
	 *         list.
	 */
	...
	/**
	 * @param ref The reference value to check against.
	 * @param doubles The list of doubles to check.
	...
	/**
	 * @param ref The reference value to check against.
	 * @param bigDecimals The list of integers to check.
