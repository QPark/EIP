...
public abstract class DBUtil {
	/**
	 * Set the maximum result set of the {@link TypedQuery}.
	 * @param typedQuery The {@link TypedQuery}
	 * @param maxElements The maximum number of elements if given.
	 */
	public static void setMaxElements(final TypedQuery<?> typedQuery,
			final BigInteger maxElements, final Map<String, String> properties) {
		if (typedQuery != null) {
	...
	/**
	 * If the criteria does not start or end with <code>*</code> it will appended. Then the method
	 * replaces all occurrences of <code>?</code> by <code>_</code> and <code>*</code> by
	 * <code>%</code>.
