...
public class KeyValue<T> implements Entry<String, T>, Comparable<KeyValue<T>> {
	...
	int ret = 0;
	if (this.key == o.key || this.key != null && o.key != null && this.key.equals(o.key)) {
	    if (this.value == o.value || this.value != null && o.value != null && this.value.equals(o.value)) {
		ret = 0;
		...
		ret = String.valueOf(this.value).compareTo(String.valueOf(o.value));
	    }
