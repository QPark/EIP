...
public abstract class FailureAssert {
     ...
     * @see StringUtils#hasText
     */
    public static void hasText(final String text, final String errorCode, final Object... data) {
	if (!StringUtils.hasText(text)) {
	    BaseFailureHandler.throwFailureException(errorCode, text, data);
	}
    }
     ...
     *             if expression is <code>false</code>
     */
    public static void isTrue(final boolean expression, final String errorCode, final Object... data) {
	if (!expression) {
     ...
     */
    public static void noNullElements(final Object[] array, final String errorCode) {
	if (array != null) {
     ...
     *             if the object is <code>null</code>
     */
    public static void notNull(final Object object, final String errorCode, final Object... data) {
	if (object == null) {
	    BaseFailureHandler.throwFailureException(errorCode, data);
	}
    }
     ...
     *             if expression is <code>false</code>
     */
    public static void state(final boolean expression, final String errorCode, final Object... data) {
	if (!expression) {
	    BaseFailureHandler.throwFailureException(errorCode, data);
	}
    }
