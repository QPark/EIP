...
public class ExtendedJAXBEqualsStrategy extends JAXBEqualsStrategy {
	 ...
	 *      org.jvnet.jaxb2_commons.locator.ObjectLocator, java.lang.Object, java.lang.Object)
	 */
	@Override
	protected boolean equalsInternal(final ObjectLocator leftLocator,
			final ObjectLocator rightLocator, final Object lhs, final Object rhs) {
	...
	/**
	 * Compares {@link XMLGregorianCalendar} by {@link XMLGregorianCalendar#toGregorianCalendar()}.
	 * @param leftLocator
	 * @param rightLocator
	 * @param left
	 * @param right
