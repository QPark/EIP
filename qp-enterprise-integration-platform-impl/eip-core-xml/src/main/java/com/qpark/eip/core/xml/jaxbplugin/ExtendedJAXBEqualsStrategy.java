 ...
 *
 ******************************************************************************/
package com.qpark.eip.core.xml.jaxbplugin;
...
public class ExtendedJAXBEqualsStrategy extends JAXBEqualsStrategy {
     ...
     * @return
     */
    protected boolean equalsInternal(final ObjectLocator leftLocator, final ObjectLocator rightLocator,
    ...
    @Override
    protected boolean equalsInternal(final ObjectLocator leftLocator, final ObjectLocator rightLocator,
	    final Object lhs, final Object rhs) {
     ...
     */
    protected boolean equalsInternal(final ObjectLocator leftLocator, final ObjectLocator rightLocator,
	    final XMLGregorianCalendar left, final XMLGregorianCalendar right) {
	boolean equals = false;
	if (left == right) {
	    equals = true;
	} else if (left != null && right != null) {
	...
	Collections.sort(l, new Comparator<Object>() {
		...
		if (o1 != o2) {
			...
			ret = Long.valueOf(o1.hashCode()) - Long.valueOf(o2.hashCode());
		    }
		}
		if (ret > 0) {
		    ret = 1;
