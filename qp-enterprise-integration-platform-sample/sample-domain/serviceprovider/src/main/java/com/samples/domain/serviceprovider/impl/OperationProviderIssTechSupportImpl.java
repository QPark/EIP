 ...
 * <pre>
 * ------------------------------------------------------------------------------------------------------
 * Generated by the EIP code generator version 3.17.1 at 2020-10-30T17:24:11
 *
 ...
 */
@Component
public class OperationProviderIssTechSupportImpl implements OperationProviderIssTechSupport {
	/** The {@link Logger}. */
	private final Logger logger = LoggerFactory.getLogger(OperationProviderIssTechSupportImpl.class);
	...
	public AppOperationEventResponseType appOperationEvent(
		...
		try {
			...
			JAXBElement<AppOperationEventResponseType> response = this.appOperationEvent
					.invoke(this.of
							.createAppOperationEventRequest(request));
			if (response != null) {
				value = response.getValue();
			}
		} finally {
			this.requestFinalization();
			this.logger.debug(" appOperationEvent duration {}", requestDuration(start));
			this.logger.debug("-appOperationEvent");
		}
		return value;
	}
	...
	public GetAggregatedReferenceDataResponseType getAggregatedReferenceData(
		...
		try {
			...
			this.requestFinalization();
			this.logger.debug(" getAggregatedReferenceData duration {}", requestDuration(start));
			this.logger.debug("-getAggregatedReferenceData");
		}
		return value;
	}
	...
	public GetFailureMessageResponseType getFailureMessage(
		...
		try {
			...
			JAXBElement<GetFailureMessageResponseType> response = this.getFailureMessage
					.invoke(this.of
							.createGetFailureMessageRequest(request));
			if (response != null) {
				value = response.getValue();
			}
		} finally {
			this.requestFinalization();
			this.logger.debug(" getFailureMessage duration {}", requestDuration(start));
			this.logger.debug("-getFailureMessage");
		}
		return value;
	}
	...
	public GetFlowReportResponseType getFlowReport(
		...
		try {
			...
			JAXBElement<GetFlowReportResponseType> response = this.getFlowReport
					.invoke(this.of
							.createGetFlowReportRequest(request));
			if (response != null) {
				value = response.getValue();
			}
		} finally {
			this.requestFinalization();
			this.logger.debug(" getFlowReport duration {}", requestDuration(start));
			this.logger.debug("-getFlowReport");
		}
		return value;
	}
	...
	public GetForwardedReferenceDataResponseType getForwardedReferenceData(
		...
		try {
			...
			this.requestFinalization();
			this.logger.debug(" getForwardedReferenceData duration {}", requestDuration(start));
			this.logger.debug("-getForwardedReferenceData");
		}
		return value;
	}
	...
	public GetOperationReportResponseType getOperationReport(
		...
		try {
			...
			JAXBElement<GetOperationReportResponseType> response = this.getOperationReport
					.invoke(this.of
							.createGetOperationReportRequest(request));
			if (response != null) {
				value = response.getValue();
			}
		} finally {
			this.requestFinalization();
			this.logger.debug(" getOperationReport duration {}", requestDuration(start));
			this.logger.debug("-getOperationReport");
		}
		return value;
	}
	...
	public GetSoapFaultResponseType getSoapFault(
		...
		try {
			...
			JAXBElement<GetSoapFaultResponseType> response = this.getSoapFault
					.invoke(this.of
							.createGetSoapFaultRequest(request));
			if (response != null) {
				value = response.getValue();
			}
		} finally {
			this.requestFinalization();
			this.logger.debug(" getSoapFault duration {}", requestDuration(start));
			this.logger.debug("-getSoapFault");
		}
		return value;
	}
	...
	public GetSystemUserReportResponseType getSystemUserReport(
		...
		try {
			...
			JAXBElement<GetSystemUserReportResponseType> response = this.getSystemUserReport
					.invoke(this.of
							.createGetSystemUserReportRequest(request));
			if (response != null) {
				value = response.getValue();
			}
		} finally {
			this.requestFinalization();
			this.logger.debug(" getSystemUserReport duration {}", requestDuration(start));
			this.logger.debug("-getSystemUserReport");
		}
		return value;
	}
