...
public class GetTargetNamespaceOperation {
	/**
	 * The
	 * {@link com.qpark.eip.core.model.analysis.operation.GetTargetNamespaceOperation}
	 * .
	 */
	@Autowired
	@Qualifier(com.qpark.eip.core.model.analysis.operation.GetTargetNamespaceOperation.BEAN_NAME)
	private com.qpark.eip.core.model.analysis.operation.GetTargetNamespaceOperation operation;
