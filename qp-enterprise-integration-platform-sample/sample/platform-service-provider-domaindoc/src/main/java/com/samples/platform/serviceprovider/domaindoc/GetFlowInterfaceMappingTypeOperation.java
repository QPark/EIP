 ...
 * @author bhausen
 */
@Component("operationProviderDomainDocGetFlowInterfaceMappingType")
public class GetFlowInterfaceMappingTypeOperation {
	/**
	 * The
	 * {@link com.qpark.eip.core.model.analysis.operation.GetFlowInterfaceMappingTypeOperation}
	 * .
	 */
	@Autowired
	@Qualifier(com.qpark.eip.core.model.analysis.operation.GetFlowInterfaceMappingTypeOperation.BEAN_NAME)
	private com.qpark.eip.core.model.analysis.operation.GetFlowInterfaceMappingTypeOperation operation;
