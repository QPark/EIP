...
-- Generated at 20160913-232115.826.
-----------------------------------------------------------------------------
...
CREATE TABLE OPERATIONTYPE (HJID NUMBER(19) NOT NULL, DTYPE VARCHAR2(31) NULL, ID VARCHAR2(36) NULL, MODELVERSION VARCHAR2(127) NULL, NAME_ VARCHAR2(511) NULL, NAMESPACE VARCHAR2(511) NULL, PARENTID VARCHAR2(36) NULL, SECURITYROLENAME VARCHAR2(511) NULL, SHORTNAME VARCHAR2(511) NULL, REQUESTRESPONSE_OPERATIONTYP_0 NUMBER(19) NULL, OPERATION__SERVICETYPE_HJID NUMBER(19) NULL, PRIMARY KEY (HJID));
...
CREATE TABLE REQUESTRESPONSEDATATYPE (HJID NUMBER(19) NOT NULL, DTYPE VARCHAR2(31) NULL, ID VARCHAR2(36) NULL, MODELVERSION VARCHAR2(127) NULL, NAME_ VARCHAR2(511) NULL, NAMESPACE VARCHAR2(511) NULL, PARENTID VARCHAR2(36) NULL, REQUESTDESCRIPTION VARCHAR2(2047) NULL, REQUESTELEMENTDESCRIPTION VARCHAR2(2047) NULL, REQUESTID VARCHAR2(36) NULL, RESPONSEDESCRIPTION VARCHAR2(2047) NULL, RESPONSEELEMENTDESCRIPTION VARCHAR2(2047) NULL, RESPONSEID VARCHAR2(36) NULL, PRIMARY KEY (HJID));
