...
ALTER TABLE FLOWFILTERTYPE DROP CONSTRAINT FLWFLTRTYPERLFLWPRCESSTYPEHJID;
...
ALTER TABLE FLOWRULETYPE DROP CONSTRAINT FLWRLTYPERLNUTFLOWRULETYPEHJID;
...
ALTER TABLE FLOWPROCESSTYPE_EXECUTIONORD_0 DROP CONSTRAINT FLWPROCESSTYPEEXECUTIONORD0HJD;
...
DROP INDEX FLWFFLWFLTRTYPRLFLWPRCSSTYPHJD;
...
DROP INDEX FLWRLTYFLWRLTYPRLNTFLWRLTYPHJD;
DROP TABLE FLOWRULETYPE CASCADE CONSTRAINTS;
...
DROP INDEX FLWPRCSSTFLWPRCSSTYPXCTNRD0HJD;
DROP TABLE FLOWPROCESSTYPE_EXECUTIONORD_0 CASCADE CONSTRAINTS;
