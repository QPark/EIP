 ...
 * <p>
 * Java-Klasse für RequestResponseDataType complex type.
 * <p>
...
@XmlType(name = "RequestResponseDataType", propOrder = { "id", "modelVersion",
		"parentId", "name", "namespace", "requestId", "responseId" })
@Entity(name = "RequestResponseDataType")
@Table(name = "REQUESTRESPONSEDATATYPE")
@Inheritance(strategy = InheritanceType.JOINED)
public class RequestResponseDataType implements Serializable, Equals, HashCode {
	...
	public boolean equals(final ObjectLocator thisLocator,
		...
		}
		{
			...
			if (!strategy.equals(
					LocatorUtils.property(thisLocator, "requestId",
							lhsRequestId),
					LocatorUtils.property(thatLocator, "requestId",
							rhsRequestId),
		...
		}
		{
			...
			if (!strategy.equals(
					LocatorUtils.property(thisLocator, "responseId",
							lhsResponseId),
					LocatorUtils.property(thatLocator, "responseId",
							rhsResponseId),
	...
	public int hashCode(final ObjectLocator locator,
		...
		}
		{
			...
			currentHashCode = strategy.hashCode(
					LocatorUtils.property(locator, "requestId", theRequestId),
					currentHashCode, theRequestId);
		}
		{
			String theResponseId;
			theResponseId = this.getResponseId();
			currentHashCode = strategy.hashCode(
					LocatorUtils.property(locator, "responseId", theResponseId),
					currentHashCode, theResponseId);
		}
