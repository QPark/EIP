 ...
 * <p>
 * Java-Klasse für DataType complex type.
 * <p>
 ...
 *         &lt;element name="javaPackageName" type="{http://www.w3.org/2001/XMLSchema}normalizedString"/&gt;
 *         &lt;element name="javaClassName" type="{http://www.w3.org/2001/XMLSchema}normalizedString"/&gt;
...
@XmlType(name = "DataType",
		propOrder = { "id", "modelVersion", "parentId", "name", "namespace",
				"javaPackageName", "javaClassName", "description" })
@XmlSeeAlso({ FieldMappingType.class, InterfaceMappingType.class,
		ComplexType.class })
@Entity(name = "DataType")
@Table(name = "DATATYPE")
@Inheritance(strategy = InheritanceType.JOINED)
public class DataType implements Serializable, Equals, HashCode {
	 ...
	 */
	@Basic
	@Column(name = "JAVAPACKAGENAME", length = 512)
	 ...
	 *            allowed object is {@link String }
	 */
	public void setJavaPackageName(final String value) {
	 ...
	 */
	@Basic
	@Column(name = "JAVACLASSNAME", length = 512)
	 ...
	 *            allowed object is {@link String }
	 */
	public void setJavaClassName(final String value) {
	...
	public boolean equals(final ObjectLocator thisLocator,
		...
		}
		{
			...
			if (!strategy.equals(
					LocatorUtils.property(thisLocator, "javaPackageName",
							lhsJavaPackageName),
					LocatorUtils.property(thatLocator, "javaPackageName",
							rhsJavaPackageName),
					lhsJavaPackageName, rhsJavaPackageName)) {
				return false;
			}
		}
		{
			...
			if (!strategy.equals(
					LocatorUtils.property(thisLocator, "javaClassName",
							lhsJavaClassName),
					LocatorUtils.property(thatLocator, "javaClassName",
							rhsJavaClassName),
					lhsJavaClassName, rhsJavaClassName)) {
				return false;
			}
		}
		{
	...
	public int hashCode(final ObjectLocator locator,
		...
		}
		{
			...
			currentHashCode = strategy.hashCode(
					LocatorUtils.property(locator, "javaPackageName",
							theJavaPackageName),
					currentHashCode, theJavaPackageName);
		}
		{
			String theJavaClassName;
			theJavaClassName = this.getJavaClassName();
			currentHashCode = strategy.hashCode(
					LocatorUtils.property(locator, "javaClassName",
							theJavaClassName),
					currentHashCode, theJavaClassName);
		}
		{
