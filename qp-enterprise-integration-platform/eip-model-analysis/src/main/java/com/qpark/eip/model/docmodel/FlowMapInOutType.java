 ...
 * <p>
 * Java-Klasse für FlowMapInOutType complex type.
 * <p>
 ...
 *         &lt;element name="interfaceMappingId" type="{http://www.w3.org/2001/XMLSchema}normalizedString" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "FlowMapInOutType", propOrder = { "id", "modelVersion",
		"parentId", "name", "namespace", "mapInOut", "interfaceMappingId" })
@Entity(name = "FlowMapInOutType")
@Table(name = "FLOWMAPINOUTTYPE")
@Inheritance(strategy = InheritanceType.JOINED)
public class FlowMapInOutType implements Serializable, Equals, HashCode {
	 ...
	 */
	public void setMapInOut(final RequestResponseDataType value) {
		this.mapInOut = value;
	}
	 ...
	 * <CODE>set</CODE> method for the interfaceMappingId property.
	 * <p>
	...
	@CollectionTable(name = "FLOWMAPINOUTTYPE_INTERFACEMA_0",
			joinColumns = { @JoinColumn(name = "HJID") })
	public List<String> getInterfaceMappingId() {
		if (this.interfaceMappingId == null) {
			this.interfaceMappingId = new ArrayList<String>();
		}
	 ...
	 * 
	 */
	public void setInterfaceMappingId(final List<String> interfaceMappingId) {
		this.interfaceMappingId = interfaceMappingId;
	}

	@Transient
	public boolean isSetInterfaceMappingId() {
		return ((this.interfaceMappingId != null)
				&& (!this.interfaceMappingId.isEmpty()));
	}
	...
	public boolean equals(final ObjectLocator thisLocator,
		...
		}
		{
			...
			lhsInterfaceMappingId = (this.isSetInterfaceMappingId()
					? this.getInterfaceMappingId() : null);
			List<String> rhsInterfaceMappingId;
			rhsInterfaceMappingId = (that.isSetInterfaceMappingId()
					? that.getInterfaceMappingId() : null);
			if (!strategy.equals(
					LocatorUtils.property(thisLocator, "interfaceMappingId",
							lhsInterfaceMappingId),
					LocatorUtils.property(thatLocator, "interfaceMappingId",
							rhsInterfaceMappingId),
					lhsInterfaceMappingId, rhsInterfaceMappingId)) {
				return false;
			}
		}
		return true;
	...
	public int hashCode(final ObjectLocator locator,
		...
		}
		{
			...
			theInterfaceMappingId = (this.isSetInterfaceMappingId()
					? this.getInterfaceMappingId() : null);
			currentHashCode = strategy.hashCode(
					LocatorUtils.property(locator, "interfaceMappingId",
							theInterfaceMappingId),
					currentHashCode, theInterfaceMappingId);
		}
