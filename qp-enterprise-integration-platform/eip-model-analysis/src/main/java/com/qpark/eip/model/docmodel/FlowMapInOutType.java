 ...
 *         &lt;element name="mapInFieldDescription" type="{http://www.qpark-consulting.com/EIP/Utility/DocumentationModel}descriptionType" minOccurs="0"/&gt;
 *         &lt;element name="mapOutFieldDescription" type="{http://www.qpark-consulting.com/EIP/Utility/DocumentationModel}descriptionType" minOccurs="0"/&gt;
...
@XmlType(name = "FlowMapInOutType", propOrder = {
    ...
    "name",
    "namespace",
    "mapInFieldDescription",
    "mapOutFieldDescription",
    "mapInOut",
    "interfaceMappingId"
})
    ...
    implements Serializable, Equals, HashCode
{
    ...
    protected String mapInFieldDescription;
    protected String mapOutFieldDescription;
    @XmlElement(required = true)
    ...
    /**
     * Ruft den Wert der mapInFieldDescription-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link String }
     ...
     */
    @Basic
    @Column(name = "MAPINFIELDDESCRIPTION", length = 2047)
    public String getMapInFieldDescription() {
        return mapInFieldDescription;
    }

    /**
     * Legt den Wert der mapInFieldDescription-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setMapInFieldDescription(String value) {
        this.mapInFieldDescription = value;
    }

    @Transient
    public boolean isSetMapInFieldDescription() {
        return (this.mapInFieldDescription!= null);
    }

    /**
     * Ruft den Wert der mapOutFieldDescription-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link String }
     ...
     */
    @Basic
    @Column(name = "MAPOUTFIELDDESCRIPTION", length = 2047)
    public String getMapOutFieldDescription() {
        return mapOutFieldDescription;
    }

    /**
     * Legt den Wert der mapOutFieldDescription-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setMapOutFieldDescription(String value) {
        this.mapOutFieldDescription = value;
    }

    @Transient
    public boolean isSetMapOutFieldDescription() {
        return (this.mapOutFieldDescription!= null);
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            String lhsMapInFieldDescription;
            lhsMapInFieldDescription = this.getMapInFieldDescription();
            String rhsMapInFieldDescription;
            rhsMapInFieldDescription = that.getMapInFieldDescription();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mapInFieldDescription", lhsMapInFieldDescription), LocatorUtils.property(thatLocator, "mapInFieldDescription", rhsMapInFieldDescription), lhsMapInFieldDescription, rhsMapInFieldDescription)) {
                return false;
            }
        }
        {
            String lhsMapOutFieldDescription;
            lhsMapOutFieldDescription = this.getMapOutFieldDescription();
            String rhsMapOutFieldDescription;
            rhsMapOutFieldDescription = that.getMapOutFieldDescription();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mapOutFieldDescription", lhsMapOutFieldDescription), LocatorUtils.property(thatLocator, "mapOutFieldDescription", rhsMapOutFieldDescription), lhsMapOutFieldDescription, rhsMapOutFieldDescription)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            String theMapInFieldDescription;
            theMapInFieldDescription = this.getMapInFieldDescription();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mapInFieldDescription", theMapInFieldDescription), currentHashCode, theMapInFieldDescription);
        }
        {
            String theMapOutFieldDescription;
            theMapOutFieldDescription = this.getMapOutFieldDescription();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mapOutFieldDescription", theMapOutFieldDescription), currentHashCode, theMapOutFieldDescription);
        }
        {
