    ...
    implements Serializable, Equals, HashCode
{
     ...
     * This is why there is not a <CODE>set</CODE> method for the executionOrder property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getExecutionOrder().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    @CollectionTable(name = "FLOWPROCESSTYPE_EXECUTIONORD_0", joinColumns = {
    ...
    public boolean isSetExecutionOrder() {
        return ((this.executionOrder!= null)&&(!this.executionOrder.isEmpty()));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            List<String> lhsExecutionOrder;
            lhsExecutionOrder = (this.isSetExecutionOrder()?this.getExecutionOrder():null);
            List<String> rhsExecutionOrder;
            rhsExecutionOrder = (that.isSetExecutionOrder()?that.getExecutionOrder():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "executionOrder", lhsExecutionOrder), LocatorUtils.property(thatLocator, "executionOrder", rhsExecutionOrder), lhsExecutionOrder, rhsExecutionOrder)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            theExecutionOrder = (this.isSetExecutionOrder()?this.getExecutionOrder():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "executionOrder", theExecutionOrder), currentHashCode, theExecutionOrder);
        }
        {
