 ...
 *         &lt;element name="simpleType" type="{http://www.qpark-consulting.com/EIP/Utility/DocumentationModel}SimpleType" maxOccurs="unbounded" minOccurs="0"/&gt;
    ...
    implements Serializable, Equals, HashCode
{
     ...
     * 
     */
    @OneToMany(targetEntity = SimpleType.class, cascade = {
        CascadeType.ALL
    })
    @JoinColumn(name = "SIMPLETYPE_CLUSTERTYPE_HJID")
     ...
     * 
     */
    public void setSimpleType(List<SimpleType> simpleType) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            List<SimpleType> lhsSimpleType;
            lhsSimpleType = (this.isSetSimpleType()?this.getSimpleType():null);
            List<SimpleType> rhsSimpleType;
            rhsSimpleType = (that.isSetSimpleType()?that.getSimpleType():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "simpleType", lhsSimpleType), LocatorUtils.property(thatLocator, "simpleType", rhsSimpleType), lhsSimpleType, rhsSimpleType)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            List<SimpleType> theSimpleType;
            theSimpleType = (this.isSetSimpleType()?this.getSimpleType():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "simpleType", theSimpleType), currentHashCode, theSimpleType);
        }
        {
