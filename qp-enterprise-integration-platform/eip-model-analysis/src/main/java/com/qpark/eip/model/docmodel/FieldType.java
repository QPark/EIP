 ...
 * <p>
 * Java-Klasse für FieldType complex type.
 * <p>
...
@XmlType(name = "FieldType",
		propOrder = { "id", "modelVersion", "parentId", "name", "namespace",
				"fieldTypeDefinitionId", "cardinality", "cardinalityMinOccurs",
				"cardinalityMaxOccurs", "listField", "optionalField",
				"description" })
@Entity(name = "FieldType")
@Table(name = "FIELDTYPE")
@Inheritance(strategy = InheritanceType.JOINED)
public class FieldType implements Serializable, Equals, HashCode {
	 ...
	 */
	@Basic
	@Column(name = "FIELDTYPEDEFINITIONID", length = 36)
	public String getFieldTypeDefinitionId() {
		return this.fieldTypeDefinitionId;
	}
	 ...
	 *            allowed object is {@link String }
	 */
	public void setFieldTypeDefinitionId(final String value) {
	...
	public Integer getCardinalityMinOccurs() {
		return this.cardinalityMinOccurs;
	}
	 ...
	 */
	public void setCardinalityMinOccurs(final Integer value) {
	...
	public Integer getCardinalityMaxOccurs() {
		return this.cardinalityMaxOccurs;
	}
	 ...
	 *            allowed object is {@link Integer }
	 */
	public void setCardinalityMaxOccurs(final Integer value) {
	 ...
	 */
	public void setListField(final boolean value) {
	 ...
	 */
	public void setOptionalField(final boolean value) {
	...
	public boolean equals(final ObjectLocator thisLocator,
		...
		}
		{
			...
			if (!strategy.equals(
					LocatorUtils.property(thisLocator, "fieldTypeDefinitionId",
							lhsFieldTypeDefinitionId),
					LocatorUtils.property(thatLocator, "fieldTypeDefinitionId",
							rhsFieldTypeDefinitionId),
					lhsFieldTypeDefinitionId, rhsFieldTypeDefinitionId)) {
				return false;
			}
		}
		{
			...
			if (!strategy.equals(
					LocatorUtils.property(thisLocator, "cardinality",
							lhsCardinality),
					LocatorUtils.property(thatLocator, "cardinality",
							rhsCardinality),
		...
		}
		{
			...
			if (!strategy.equals(
					LocatorUtils.property(thisLocator, "cardinalityMinOccurs",
							lhsCardinalityMinOccurs),
					LocatorUtils.property(thatLocator, "cardinalityMinOccurs",
							rhsCardinalityMinOccurs),
					lhsCardinalityMinOccurs, rhsCardinalityMinOccurs)) {
				return false;
			}
		}
		{
			...
			if (!strategy.equals(
					LocatorUtils.property(thisLocator, "cardinalityMaxOccurs",
							lhsCardinalityMaxOccurs),
					LocatorUtils.property(thatLocator, "cardinalityMaxOccurs",
							rhsCardinalityMaxOccurs),
					lhsCardinalityMaxOccurs, rhsCardinalityMaxOccurs)) {
				return false;
			}
		}
		{
			...
			if (!strategy.equals(
					LocatorUtils.property(thisLocator, "listField",
							lhsListField),
					LocatorUtils.property(thatLocator, "listField",
							rhsListField),
					lhsListField, rhsListField)) {
				return false;
			}
		}
		{
			...
			if (!strategy.equals(
					LocatorUtils.property(thisLocator, "optionalField",
							lhsOptionalField),
					LocatorUtils.property(thatLocator, "optionalField",
							rhsOptionalField),
					lhsOptionalField, rhsOptionalField)) {
				return false;
			}
		}
		{
	...
	public int hashCode(final ObjectLocator locator,
		...
		}
		{
			...
			currentHashCode = strategy.hashCode(
					LocatorUtils.property(locator, "fieldTypeDefinitionId",
							theFieldTypeDefinitionId),
					currentHashCode, theFieldTypeDefinitionId);
		}
		{
			...
			currentHashCode = strategy
					.hashCode(
							LocatorUtils.property(locator, "cardinality",
									theCardinality),
							currentHashCode, theCardinality);
		}
		{
			Integer theCardinalityMinOccurs;
			theCardinalityMinOccurs = this.getCardinalityMinOccurs();
			currentHashCode = strategy.hashCode(
					LocatorUtils.property(locator, "cardinalityMinOccurs",
							theCardinalityMinOccurs),
					currentHashCode, theCardinalityMinOccurs);
		}
		{
			Integer theCardinalityMaxOccurs;
			theCardinalityMaxOccurs = this.getCardinalityMaxOccurs();
			currentHashCode = strategy.hashCode(
					LocatorUtils.property(locator, "cardinalityMaxOccurs",
							theCardinalityMaxOccurs),
					currentHashCode, theCardinalityMaxOccurs);
		}
		{
			boolean theListField;
			theListField = this.isListField();
			currentHashCode = strategy.hashCode(
					LocatorUtils.property(locator, "listField", theListField),
					currentHashCode, theListField);
		}
		{
			boolean theOptionalField;
			theOptionalField = this.isOptionalField();
			currentHashCode = strategy.hashCode(
					LocatorUtils.property(locator, "optionalField",
							theOptionalField),
					currentHashCode, theOptionalField);
		}
		{
