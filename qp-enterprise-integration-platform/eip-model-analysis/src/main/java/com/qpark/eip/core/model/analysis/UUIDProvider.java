...
public class UUIDProvider {
	...
	public void setUUID(final DomainType value) {
		value.setId(String.valueOf(UUID.nameUUIDFromBytes(
				new StringBuffer(128).append(DomainType.class.getName())
	...
	public void setUUID(final ClusterType value) {
		value.setId(String.valueOf(UUID.nameUUIDFromBytes(
				new StringBuffer(128).append(ClusterType.class.getName())
						.append("#").append(value.getModelVersion()).append("#")
						.append(value.getName()).toString().getBytes())));
		this.analysis.add(value.getId(), value);
	}
	...
	public void setUUID(final FlowType value) {
		value.setId(String.valueOf(UUID.nameUUIDFromBytes(
				new StringBuffer(128).append(FlowType.class.getName())
						.append("#").append(value.getModelVersion()).append("#")
						.append(value.getName()).toString().getBytes())));
		this.analysis.add(value.getId(), value);
	}
						...
						UUID.nameUUIDFromBytes(
								new StringBuffer(128)
										.append(FlowSubRequestType.class
												.getName())
										.append("#").append("#")
										.append(value.getModelVersion())
										.append(value.getName()).append("#")
										.append(value.getParentId()).toString()
										.getBytes())));
		this.analysis.add(value.getId(), value);
	}
	...
	public void setUUID(final ServiceType value) {
		value.setId(String.valueOf(UUID.nameUUIDFromBytes(
				new StringBuffer(128).append(ServiceType.class.getName())
						.append("#").append(value.getModelVersion()).append("#")
						.append(value.getName()).toString().getBytes())));
		this.analysis.add(value.getId(), value);
	}
	...
	public void setUUID(final OperationType value) {
		value.setId(String.valueOf(UUID.nameUUIDFromBytes(
				new StringBuffer(128).append(OperationType.class.getName())
						.append("#").append(value.getModelVersion()).append("#")
						.append(value.getName()).toString().getBytes())));
		this.analysis.add(value.getId(), value);
	}
	...
	public void setUUID(final ElementType value) {
		value.setId(String.valueOf(UUID.nameUUIDFromBytes(
				new StringBuffer(128).append(ElementType.class.getName())
						.append("#").append(value.getModelVersion()).append("#")
						.append(value.getName()).toString().getBytes())));
		this.analysis.add(value.getId(), value);
	}
	...
	public void setUUID(final DataType value) {
		value.setId(
				this.getDataTypeUUID(value.getName(), value.getModelVersion()));
		this.analysis.add(value.getId(), value);
	}
	...
	public String getFieldTypeUUID(final String fieldName,
			final String parentId, final String modelVersion) {
		return String.valueOf(UUID.nameUUIDFromBytes(new StringBuffer(128)
				.append(FieldType.class.getName()).append("#").append(parentId)
				.append("#").append(modelVersion).append("#").append(fieldName)
				.toString().getBytes()));
	}
	...
	public void setUUID(final FieldType value) {
		value.setId(String.valueOf(UUID.nameUUIDFromBytes(
				new StringBuffer(128).append(FieldType.class.getName())
						...
						.append(value.getModelVersion()).append("#")
						.append(value.getName()).toString().getBytes())));
		this.analysis.add(value.getId(), value);
	}
}
