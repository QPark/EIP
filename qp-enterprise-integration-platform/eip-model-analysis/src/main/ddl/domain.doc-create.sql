...
-- Generated at 20160914-102805.511.
-----------------------------------------------------------------------------
...
CREATE INDEX FLWRLTFLWRLTYPRLFLWPRCSSTYPHJD ON FLOWRULETYPE (RULE__FLOWPROCESSTYPE_HJID);
...
CREATE TABLE FIELDMAPPINGTYPE_FIELDMAPPIN_0 (HJID NUMBER(19) NULL, HJVALUE VARCHAR2(36) NULL, HJINDEX NUMBER(10) NULL);
CREATE INDEX FLDMPPNGFLDMPPNGTYPFLDMPPN0HJD ON FIELDMAPPINGTYPE_FIELDMAPPIN_0 (HJID);
...
CREATE TABLE INTERFACEMAPPINGTYPE_FIELDMA_0 (HJID NUMBER(19) NULL, HJVALUE VARCHAR2(36) NULL, HJINDEX NUMBER(10) NULL);
CREATE INDEX NTRFCMPPNNTRFCMPPNGTYPFLDM0HJD ON INTERFACEMAPPINGTYPE_FIELDMA_0 (HJID);
...
ALTER TABLE FLOWRULETYPE ADD CONSTRAINT FLWRLETYPERLFLWPROCESSTYPEHJID FOREIGN KEY (RULE__FLOWPROCESSTYPE_HJID) REFERENCES FLOWPROCESSTYPE (HJID);
...
ALTER TABLE FIELDMAPPINGTYPE_FIELDMAPPIN_0 ADD CONSTRAINT FLDMAPPINGTYPEFIELDMAPPIN0HJID FOREIGN KEY (HJID) REFERENCES DATATYPE (HJID);
...
ALTER TABLE INTERFACEMAPPINGTYPE_FIELDMA_0 ADD CONSTRAINT NTERFACEMAPPINGTYPEFIELDMA0HJD FOREIGN KEY (HJID) REFERENCES DATATYPE (HJID);
