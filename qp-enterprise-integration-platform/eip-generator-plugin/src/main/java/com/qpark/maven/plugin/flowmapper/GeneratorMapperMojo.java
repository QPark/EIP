...
public class GeneratorMapperMojo extends AbstractMojo {
	...
	XsdsUtil config = new XsdsUtil(this.baseDirectory, this.basePackageName, this.mappingPackageNameSuffixes, null,
	...
	if (basicPackageName != null) {
		...
		try {
		    DirectMappingTypeGenerator mtg = new DirectMappingTypeGenerator(config, basicPackageName, cc.ct,
			    complexContentList, this.getLog());
		...
		try {
		    DefaultMappingTypeGenerator mtg = new DefaultMappingTypeGenerator(config, basicPackageName, cc.ct,
			    complexContentList, this.getLog());
		    entry = mtg.generateInterface(this.outputInterfacesDirectory);
		    cc.packageName = entry.getKey();
		    cc.interfaceName = entry.getValue();
		...
		ComplexUUIDReferenceDataMappingTypeGenerator mtg = new ComplexUUIDReferenceDataMappingTypeGenerator(
			config, basicPackageName, cc.ct, complexContentList, this.getLog());
		entry = mtg.generateInterface(this.outputInterfacesDirectory);
		cc.packageName = entry.getKey();
		cc.interfaceName = entry.getValue();
		mtg.generateImpl(this.outputInterfacesDirectory);
		...
		ComplexMappingTypeGenerator mtg = new ComplexMappingTypeGenerator(config, basicPackageName, cc.ct,
			complexContentList, this.getLog());
		entry = mtg.generateInterface(this.outputInterfacesDirectory);
		cc.packageName = entry.getKey();
		cc.interfaceName = entry.getValue();
		...
		InterfaceMappingTypeGenerator mtg = new InterfaceMappingTypeGenerator(config, basicPackageName, cc.ct,
			complexContentList, this.getLog());
		entry = mtg.generateInterface(this.outputInterfacesDirectory);
		cc.packageName = entry.getKey();
		cc.interfaceName = entry.getValue();
		...
		MappingOperationGenerator mog = new MappingOperationGenerator(config, basicPackageName, crr.request,
			crr.response, complexContentList, this.getLog());
	...
	this.getLog().info(new StringBuffer("Generated flows:                ").append(flows).toString());
	this.getLog().info(new StringBuffer("Generated direct mappers:       ").append(directMappers).toString());
	this.getLog().info(new StringBuffer("Generated default mappers:      ").append(defaultMappers).toString());
	this.getLog().info(new StringBuffer("Generated complex UUID mappers: ").append(complexUUIDMappers).toString());
	this.getLog().info(new StringBuffer("Generated complex mappers:      ").append(complexMappers).toString());
	this.getLog().info(new StringBuffer("Generated interface mappers:    ").append(interfaceMappers).toString());
	this.getLog().info(new StringBuffer("Generated mapping operations:   ").append(mappingOperations).toString());
