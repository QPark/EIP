...
public interface EipGeneratorDefaults {
    ...
    public static final String DEFAULT_SPRING_FRAMEWORK_XSD_VERSION = "4.1";
    /** The default value of the spring integration xsd version. */
    public static final String DEFAULT_SPRING_INTEGRATION_XSD_VERSION = "4.1";
    ...
    public static final String DEFAULT_SPRING_SECURITY_XSD_VERSION = "3.2";
}
