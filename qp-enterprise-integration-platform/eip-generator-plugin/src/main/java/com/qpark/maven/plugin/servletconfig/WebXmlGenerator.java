...
public class WebXmlGenerator {
	...
	private String getWebXml() {
		...
		sb.append("\t<env-entry>\n");
		sb.append(
				"\t\t<env-entry-name>servicebus-service-name</env-entry-name>\n");
		sb.append("\t\t<env-entry-type>java.lang.String</env-entry-type>\n");
		sb.append("\t\t<env-entry-value>");
		sb.append(this.serviceId);
		sb.append("</env-entry-value>\n");
		...
		sb.append("\t<env-entry>\n");
		sb.append(
				"\t\t<env-entry-name>servicebus-version-name</env-entry-name>\n");
		sb.append("\t\t<env-entry-type>java.lang.String</env-entry-type>\n");
		sb.append("\t\t<env-entry-value>");
		sb.append(this.serviceVersion);
		sb.append("</env-entry-value>\n");
		...
		sb.append("\t<env-entry>\n");
		sb.append(
				"\t\t<env-entry-name>servicebus-build-svnrevision</env-entry-name>\n");
		sb.append("\t\t<env-entry-type>java.lang.String</env-entry-type>\n");
		sb.append("\t\t<env-entry-value>");
		sb.append(this.revisionNumber);
		sb.append("</env-entry-value>\n");
		...
		sb.append("\t<env-entry>\n");
		sb.append(
				"\t\t<env-entry-name>servicebus-build-time</env-entry-name>\n");
		sb.append("\t\t<env-entry-type>java.lang.String</env-entry-type>\n");
		sb.append("\t\t<env-entry-value>");
		sb.append(Util.getXsdDateTime(this.d));
		sb.append("</env-entry-value>\n");
		...
		if (this.additionalWebappFilter != null
			...
			sb.append("\t<filter>\n");
			sb.append(
					"\t\t<filter-name>comQparkMavenPluginServletConfigAdditionalFilter</filter-name>\n");
		...
		sb.append(
				"\t\t<location>/WEB-INF/views/errors/container-exceptions.jsp</location>\n");
		sb.append("\t</error-page>\n");
