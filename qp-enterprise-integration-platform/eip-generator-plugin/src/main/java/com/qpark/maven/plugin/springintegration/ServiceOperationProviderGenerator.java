...
public class ServiceOperationProviderGenerator {
	...
	public ServiceOperationProviderGenerator(final String serviceId, final List<IntegrationGatewayGenerator> igs,
			final String basePackageName, final Log log, final MavenProject project) {
	...
	public void generate() {
		...
		String className = new StringBuffer("OperationProvider").append(ServiceIdRegistry.capitalize(this.serviceId))
				.toString();
