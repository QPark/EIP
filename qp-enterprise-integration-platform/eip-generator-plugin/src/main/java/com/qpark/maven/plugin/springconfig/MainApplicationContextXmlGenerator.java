...
public class MainApplicationContextXmlGenerator {
	...
	public MainApplicationContextXmlGenerator(final String basePackageName,
			final String applicationWithoutPersistenceConfig,
		...
		this.log = log;
		this.applicationWithoutPersistenceConfig = Boolean
				.parseBoolean(applicationWithoutPersistenceConfig != null
						? applicationWithoutPersistenceConfig : "false");
	}
	...
	public void generate() {
		...
		sb.append(
				"\t<import resource=\"classpath:/security-spring-config.xml\"/>\n");
		sb.append("\n");
		sb.append(
				"\t<!-- The web service wsdl, dispatching and service provider routing. -->\n");
		sb.append("\t<import resource=\"classpath:/dispatcher/*.xml\"/>\n");
		sb.append("\t<import resource=\"classpath:/router/*.xml\"/>\n");
		sb.append("\n");
		sb.append(
				"\t<!-- All the service providers and utility configs. -->\n");
		sb.append(
				"\t<import resource=\"classpath*:/service-provider-spring-config.xml\" />\n");
		sb.append(
				"\t<import resource=\"classpath*:/utility-spring-config.xml\" />\n");
		sb.append("</beans>\n");
