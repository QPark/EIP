...
public class SchemaCollectionXsdMojo extends AbstractMojo {
	...
	private String getJAXBAppInfo() {
		...
		sb.append("\t\t<appinfo>\n");
		sb.append("\t\t\t<jaxb:globalBindings generateIsSetMethod=\"true\" localScoping=\"toplevel\">\n");
		...
		if (this.stringLength != null && this.stringLength.trim().length() > 0 && !this.stringLength.equals("255")) {
			...
			sb.append("\t\t\t\t<hj:default-single-property type=\"xsd:string\"><hj:basic><orm:column length=\"");
			sb.append(this.stringLength);
			sb.append("\"/></hj:basic></hj:default-single-property>\n");
