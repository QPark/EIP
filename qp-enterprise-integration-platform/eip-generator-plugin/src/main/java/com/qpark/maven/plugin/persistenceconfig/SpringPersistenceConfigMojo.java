...
public class SpringPersistenceConfigMojo extends AbstractMojo {
	 ...
	 */
	@Parameter(property = "databasePlatform", defaultValue = "org.hibernate.dialect.Oracle10gDialect")
	...
	@Parameter(property = "springJpaVendorAdapter", defaultValue = "org.springframework.orm.jpa.vendor.HibernateJpaVendorAdapter")
	...
	private String getSpringDataSourceJavaConfig() throws MojoExecutionException {
	...
	private String getSpringPersistenceJavaConfig() throws MojoExecutionException {
		...
		sb.append("\tpublic static final String DATASOURCE_JDNI_NAME = \"jdbc/");
		...
		sb.append("\tpublic static final String ENTITY_MANAGER_FACTORY_NAME = \"");
		sb.append(prefix);
		...
		sb.append("\tpublic static final String JPA_VENDOR_ADAPTER_CONFIGURATION_BEAN_NAME = \"");
		sb.append(prefix);
	...
	private String getSpringPersistenceConfigXml() throws MojoExecutionException {
		...
		if (this.databasePlatform != null && this.databasePlatform.trim().length() > 0) {
