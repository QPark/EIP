...
public class HttpServletXmlGenerator {
     ...
     * @param elementTypes
     */
    public HttpServletXmlGenerator(final XsdsUtil config, final String serviceId, final String serviceVersion,
	    final String revisionNumber, final String warName, final File outputDirectory, final MavenProject project,
	    final Log log) {
	this.config = config;
	...
	sb.append(
		"\txmlns:aop=\"http://www.springframework.org/schema/aop\" xmlns:int=\"http://www.springframework.org/schema/integration\" xmlns:int-ws=\"http://www.springframework.org/schema/integration/ws\"\n");
	sb.append(
	...
	springVersion = this.project.getProperties().getProperty("org.springframework.version.xsd.version");
	sb.append(
	...
	sb.append(".xsd\n");
	sb.append(
		"\t\thttp://www.springframework.org/schema/integration/http http://www.springframework.org/schema/integration/http/spring-integration-http\n");
	if (springVersion != null) {
	    sb.append("-").append(springVersion);
	}
	sb.append(".xsd\n");
