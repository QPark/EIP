...
public class ApplicationPropertiesConfigXmlGenerator {
	 ...
	 * @param elementTypes
	 */
	public ApplicationPropertiesConfigXmlGenerator(final String basePackageName, final String serviceId,
			final String serviceVersion, final String revisionNumber, final String placeholderConfigurerImpl,
