...
public class MappingOperationGenerator extends
	...
	/**
	 * @see com.qpark.maven.plugin.xmapper.AbstractMappingOperationGenerator#getPackageNameInterface()
	 */
	@Override
	...
	/**
	 * @see com.qpark.maven.plugin.xmapper.AbstractMappingOperationGenerator#getMethodName()
	 */
	@Override
	...
	public void generateImpl(final File outputDirectory) {
		...
		for (ComplexTypeChild requestChild : GeneratorMapper
				.getValidChildren(this.request)) {
		...
		if (mapping != null) {
			...
			for (ComplexTypeChild grandChild : GeneratorMapper
		...
		for (ComplexTypeChild responseChild : GeneratorMapper
