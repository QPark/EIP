...
public class Util {
	...
	public static String getGeneratedAtJavaDocClassHeader(final Class<?> c,
			final String eipVersion) {
		StringBuffer sb = new StringBuffer();
		sb.append(" * <pre>\n");
		sb.append(
				" * ------------------------------------------------------------------------------------------------------\n");
		sb.append(" * Generated by the EIP code generator");
		if (eipVersion != null && eipVersion.trim().length() > 0) {
			sb.append(" version ");
			sb.append(eipVersion);
		}
		sb.append(" at ");
		sb.append(getXsdDateTime(null));
		sb.append("\n");
		sb.append(" *\n");
		sb.append(
				" * Warning: Do not alter generated code! Change the domain model and re-generate the code instead.\n");
		sb.append(
				" * If you copy generated code in order to adapt it, please remove these lines and add yourself as an author.\n");
		sb.append(
				" * ------------------------------------------------------------------------------------------------------\n");
		sb.append(" *</pre>\n");
		return sb.toString();
	...
	public static String getGeneratedAtXmlComment(final Class<?> c,
			final String eipVersion) {
		StringBuffer sb = new StringBuffer();
		sb.append("<!--\n");
		sb.append(
		...
		sb.append(" *\n");
		sb.append(
				" * Warning: Do not alter generated XML! Change the domain model and re-generate the code instead.\n");
		sb.append(
				" * If you copy generated XML in order to adapt it, please remove these lines and add yourself as an author.\n");
		sb.append(
				"- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - \n");
		sb.append("-->\n");
		return sb.toString();
	...
	public static String getGeneratedAtPropertiesComment(final Class<?> c,
			final String eipVersion) {
		StringBuffer sb = new StringBuffer();
		sb.append(
				"#------------------------------------------------------------------------------------------------------\n");
		...
		sb.append("#\n");
		sb.append(
				"# Warning: Do not alter generated properties! Change the domain model and re-generate the code instead.\n");
		sb.append(
				"# If you copy generated properties in order to adapt it, please remove these lines and add yourself as an author.\n");
		sb.append(
				"#------------------------------------------------------------------------------------------------------\n");
		return sb.toString();
	}
